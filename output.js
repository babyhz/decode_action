//Fri Jun 28 2024 08:07:10 GMT+0000 (Coordinated Universal Time)
...
let _0x5832a6 = null,
  _0x3d30a7 = null;
const _0x19bf18 = "meituan",
  _0x29b2e0 = ["\n", "&", "@"],
  _0x1d722f = [_0x19bf18 + "Cookie"];
try {} catch (_0x3b904b) {}
const _0x28e1f2 = 15000,
  _0x3e8031 = 3,
  _0x16913c = process.env[_0x19bf18 + "AutoWithdraw"] || "true",
  _0x128bdf = process.env[_0x19bf18 + "MrzqTask"] || "true",
  _0x539959 = process.env[_0x19bf18 + "CyfTask"] || "true",
  _0xba91e5 = process.env[_0x19bf18 + "AppUuid"] || "";
...
let _0x23042b = "114.07" + _0x34e7e4.randomString(12, _0x49f694),
  _0x3b009f = "22.52" + _0x34e7e4.randomString(13, _0x49f694),
  _0x50dbed = "NnOIp-QOs8SiYF1dcSlL5r8phPrCf6qkH7evMyjIoup2NXxNCLYcBbd3bqpv2X2IwEEJb5qoWglfkm_BFMSF_P37OScxhIfzAWgvmEjhdwJlyDXeFPZ0XwraweVp2EDxHrRbGOZeH8QVXwCoLxaUGBeOtuA0cEaD1RsGuHC_D2E",
  _0x453d9e = [],
  _0x2d7859 = [];
const _0x5cae5c = 600,
  _0x599182 = 10,
...
function _0x663b13(_0xe63f2e) {
  return Buffer.from(_0xe63f2e, "utf8").toString("base64");
}
class _0x53c152 {
  constructor() {
    this.index = _0x34e7e4.userIdx++;
    this.name = "";
    this.valid = false;
    const _0x4b8c02 = {
      limit: 0
    ...
    this.got = _0x2d1ce3.extend(_0x3cc8a6);
  }
  log(_0x1fddf, _0x49a913 = {}) {
    var _0x300dbb = "",
      _0x54addd = _0x34e7e4.userCount.toString().length;
    if (this.index) {
      _0x300dbb += "账号[" + _0x34e7e4.padStr(this.index, _0x54addd) + "]";
    }
    if (this.name) {
      _0x300dbb += "[" + this.name + "]";
    }
    _0x34e7e4.log(_0x300dbb + _0x1fddf, _0x49a913);
  }
...
class _0x264822 extends _0x53c152 {
  constructor(_0x33d662) {
    super();
    if (_0x33d662.startsWith("token=")) {
      _0x33d662 = _0x33d662.replace("token=", "");
    }
    let _0x472d33 = _0x33d662?.["split"]("#");
    this.token = _0x472d33?.[0];
    this.specified_app_uuid = _0x472d33?.[1];
    this.t_earnDaily = 0;
    this.init_xtb_coin = 0;
    this.xtb_coin = 0;
    this.run_xtb = false;
    this.uuid = _0x34e7e4.randomPattern("186ebxxxxxxxx-22e49fxxxxxxxx-0-0-186ebxxxxxxxx");
    this.app_uuid = "00000000000009CA00" + _0x34e7e4.randomString(46).toUpperCase();
    this.openid = _0x34e7e4.randomString(7, _0x2b49ff) + "-" + _0x34e7e4.randomString(20, _0x2b49ff);
    ...
    _0x5832a6 && (this.h5guard = new _0x5832a6(this.cookie, _0x2ff58e));
  ...
  async get_mtgsig(_0x2e4ff7, _0x4e65b1) {
    const _0xe0b92d = {
      a1: "1.1",
      a2: 1700365130585,
    ...
    if (this.h5guard) {
      _0x13b41e = await this.h5guard.sign(_0x2e4ff7, _0x4e65b1);
    }
    return _0x13b41e;
  }
  ...
  async get_riskParams(_0x35e36c = true) {
    ...
    let _0x30217c = {
      uuid: this.specified_app_uuid || _0xba91e5 || this.app_uuid,
      platform: 5,
  ...
  async get_riskForm(_0x121ae9 = false) {
    ...
    let _0x187e7e = {
      ...
      _0x425162 = {
        ...
        ip: "",
        partner: 0,
        wxRiskLevel: JSON.stringify(_0x187e7e),
        platform: 13,
  ...
  async encode_riskForm(_0x3bd177 = false) {
    ...
    return _0x663b13(JSON.stringify(_0x2d9d62));
  }
  async getLoginedUserInfo(_0x2aa41d = {}) {
    ...
    try {
      ...
      let _0x5e8c28 = {
        ...
        {
          result: _0x49bcbc
        } = await this.request(_0x5e8c28);
      if (_0x49bcbc?.["mobile"]) {
        _0x3dde4c = true;
        this.valid = true;
        this.name = _0x49bcbc.mobile;
        ...
        this.log("获取账号信息失败, ck可能失效", _0x45f57b);
      }
    } catch (_0x51239b) {
  ...
  async inviteFetchcoupon(_0x23d557 = {}) {
    try {
      ...
      let _0x227bde = {
        ...
        {
          result: _0x28fc4c
        } = await this.request(_0x227bde),
        _0x10c223 = _0x34e7e4.get(_0x28fc4c, "code", -1),
        _0x118a10 = _0x34e7e4.get(_0x28fc4c, "subcode", -1);
  ...
  async gundamGrabV4(_0x44d147, _0x4494aa = {}) {
    try {
      ...
      let _0x3bb9b6 = _0x3772da,
        {
          result: _0x481c27
        } = await this.request(_0x3bb9b6),
        _0xeec91e = _0x34e7e4.get(_0x481c27, "code", -1);
      if (_0xeec91e == 0) {
    ...
    try {
      let _0x42c54a = {
          ...
          searchParams: {
            ...
            gdPageId: _0x34e7e4.get(_0x2c45f3, "gdPageId", "0"),
            instanceId: _0x34e7e4.get(_0x2c45f3, "instanceId", ""),
            appType: 0,
            deviceType: 2,
            token: this.token,
            userId: this.userId,
        ...
        _0xd04196 = _0x34e7e4.get(_0x108031, "code", -1);
      if (_0xd04196 == 0) {
        let {
    ...
    try {
      let _0x40f242 = {
          ...
          searchParams: {
            ...
            cType: _0x34e7e4.get(_0x1e60d3, "cType", "wm_wxapp"),
            wm_appversion: _0x34e7e4.get(_0x1e60d3, "wm_appversion", "9.19.6"),
            gdPageId: _0x34e7e4.get(_0x1e60d3, "gdPageId", "460584"),
            token: this.token,
            userId: this.userId,
            uuid: this.uuid
          },
        ...
        _0x169b72 = _0x34e7e4.get(_0x44fd5d, "code", -1);
      if (_0x169b72 == 0) {
        let _0x4ad2fe = [];
    ...
    try {
      let _0x1509b9 = {
          ...
          searchParams: {
            ...
            isInDpEnv: 0,
            isMini: 1,
            cType: _0x34e7e4.get(_0x18f443, "cType", "wm_wxapp")
          }
        },
        {
          result: _0x2509ea
        } = await this.request(_0x1509b9),
        _0x4c1369 = _0x34e7e4.get(_0x2509ea, "code", -1);
      if (_0x4c1369 == 0) {
        const _0x41783e = {
          act: _0x11b295
        };
    ...
    try {
      ...
      let _0x592245 = {
          ...
          searchParams: {
            isInDpEnv: 0,
            isMini: 1,
            cType: _0x34e7e4.get(_0x45e7a4, "cType", "wm_wxapp")
          },
          json: {
        ...
        _0x424da6 = _0x34e7e4.get(_0x4c207f, "code", -1);
      if (_0x424da6 == 0) {
  ...
  async ttsqEntry(_0x505507, _0x23a004 = {}) {
    try {
      ...
      let _0x2265c8 = {
        ...
        {
          result: _0x429bae
        } = await this.request(_0x2265c8),
        _0x5cc730 = _0x34e7e4.get(_0x429bae, "code", -1);
      if (_0x5cc730 == 0) {
  ...
  async ttsqDoAction(_0x1e6499, _0x27654a, _0x119f71 = {}) {
    try {
      let _0x1fc0e3 = {
        ...
        _0x1fed91 = _0x34e7e4.get(_0x19a197, "code", -1);
      if (_0x1fed91 == 0) {
  ...
  async ttsqEntryLottery(_0x22c1ff, _0x4ba395 = {}) {
    try {
      ...
      let _0x43812a = _0x2f19db,
        {
          result: _0x4fc654
        } = await this.request(_0x43812a),
        _0x3da06f = _0x34e7e4.get(_0x4fc654, "code", -1);
      if (_0x3da06f == 0) {
  ...
  async ttsqDoActionLottery(_0x4d8e8e, _0x43760e, _0x2a72b0 = {}) {
    try {
      let _0x15f62f = {
        ...
        _0x133bc0 = _0x34e7e4.get(_0x5b970f, "code", -1);
      if (_0x133bc0 == 0) {
    ...
    try {
      let _0x4b5686 = {
          ...
          searchParams: {
            ...
            ctype: _0x34e7e4.get(_0x139dc8, "ctype", "wm_wxapp"),
            isInDpEnv: 0
          }
        },
        {
        ...
        _0x597f0c = _0x34e7e4.get(_0x371767, "code", -1);
      if (_0x597f0c == 0) {
  ...
  async clockInSign(_0x1efae6, _0x25308f = {}) {
    try {
      ...
      let _0x4bd76e = {
          ...
          searchParams: {
            isMini: 1,
            ctype: _0x34e7e4.get(_0x25308f, "ctype", "wm_wxapp"),
            isInDpEnv: 0
          },
          json: _0x5c36a8
        },
        ...
        _0xa649d6 = _0x34e7e4.get(_0xbcbc3d, "code", -1);
      if (_0xa649d6 == 0) {
  ...
  async getCardInfo(_0x2b046e, _0x361eaa = {}) {
    try {
      ...
      let _0x3e877 = {
        ...
        {
          result: _0x31babc
        } = await this.request(_0x3e877),
        _0x300749 = _0x34e7e4.get(_0x31babc, "code", -1);
      if (_0x300749 == 0) {
        ...
        for (let _0x5a3f71 of _0x5c6210.data) {
          if (!_0x21c87d.includes(_0x5a3f71?.["code"]?.["toString"]())) {
            ...
            if (_0x12d442 && _0x5a3f71?.["extend"]?.["isSignInToday"] == 1) {
              _0x34e7e4.log("任务[" + _0x5a3f71.title + "] -- 已完成");
              continue;
            }
            let _0xa28e7b = false;
            ...
            for (let _0x1956e0 of _0x5a3f71.taskRuleVos) {
              if (_0x1956e0.status == "PRIZE_SUCC" || _0x1956e0.status == "DELETE") {
                !_0x12d442 && _0x34e7e4.log("任务[" + _0x5a3f71.title + "] -- 已完成");
              } else {
                if (_0x1956e0?.["status"] == "CAN_RECEIVE") {
                  _0x34e7e4.log("任务[" + _0x5a3f71.title + "] -- 可领取奖励");
                  const _0x128294 = {
                    need_sign: _0xa28e7b
                  };
                  ...
                  _0x34e7e4.log("任务[" + _0x5a3f71.title + "] -- 未完成");
                  let _0x1863c8 = true,
                  ...
                  if (_0x4e5f0c.limitTime) {
                    ...
                    Date.now() < _0x5badcf && (_0x1863c8 = false, _0x34e7e4.log("任务[" + _0x5a3f71.title + "]冷却中, [" + _0x34e7e4.time("hh:mm:ss", _0x5badcf) + "]后可完成"));
                  } else {
                    if (_0x4e5f0c?.["timeLimits"]?.["length"]) {
                      let _0x249df2 = new Date(_0x34e7e4.time("yyyy-MM-dd 00:00:00")).getTime(),
                        _0x4c553e = Date.now();
                      for (let _0x56092a of _0x4e5f0c.timeLimits) {
                        ...
                        _0x41fc28 += _0x249df2;
                        _0x423185 += _0x249df2;
                        (_0x4c553e < _0x41fc28 || _0x4c553e >= _0x423185) && (_0x1863c8 = false, _0x34e7e4.log("任务[" + _0x5a3f71.title + "]不在时间段中: " + _0x34e7e4.time("hh:mm:ss", _0x41fc28) + "到" + _0x34e7e4.time("hh:mm:ss", _0x423185)));
                      }
                    }
                  }
                  if (_0x1863c8) {
  ...
  async startUserTask(_0x354b8d, _0x46d86b, _0x20b5da, _0x3a284a = {}) {
    try {
      ...
      if (_0x293afa) {
        ...
        _0x271772.headers = _0xd957df;
      }
      let {
        result: _0x127cbe
      } = await this.request(_0x271772);
      if (_0x127cbe?.["code"] == 0) {
        ...
        if (_0x2aa7ae.staySeconds) {
          ...
          await _0x34e7e4.wait(_0x429a60);
        } else {
      ...
      if (_0x4c98e7.number) {
        ...
        if (_0x4c98e7?.["sendMagicCardResult"]?.["cardList"]?.["length"]) {
          for (let _0x454f09 of _0x4c98e7.sendMagicCardResult.cardList) {
            _0xfba337.push("[" + (_0x1a1c09[_0x454f09.type] || _0x454f09.type) + "]x" + _0x454f09.amount);
          }
        } else {
          if (_0x4c98e7?.["sendMagicStoneResult"]?.["stoneList"]?.["length"]) {
            for (let _0x5deea0 of _0x4c98e7.sendMagicStoneResult.stoneList) {
              _0xfba337.push("[" + (_0x51b431[_0x5deea0.magicStonePrizeType] || _0x5deea0.magicStonePrizeType) + "]x" + _0x5deea0.amount);
            }
          } else {
  ...
  async updateUserTask(_0x4ebb1e, _0x3370a5, _0x5f418f, _0x3ed439 = {}, _0x593b92 = {}) {
    try {
      ...
      if (_0x242062) {
        ...
        _0x491805.headers = _0x2b209a;
      }
      let {
        result: _0x21ec84
      } = await this.request(_0x491805);
      if (_0x21ec84?.["code"] == 0) {
  ...
  async sendTaskPrize(_0x5bf3b9, _0x194f51, _0x40bd00, _0x2361a8 = {}, _0x5de907 = {}) {
    try {
      ...
      if (_0x3edf38) {
        ...
        _0xd4fd08.headers = _0x568611;
      }
      let {
        result: _0xea68ac
      } = await this.request(_0xd4fd08);
      if (_0xea68ac?.["code"] == 0) {
    ...
    try {
      ...
      let _0x31f9ab = {
          ...
          searchParams: {
            ...
            nonceStr: _0x34e7e4.randomString(16),
        ...
        _0x3001dd = _0x34e7e4.get(_0x1b3b2e, "code", -1);
      if (_0x3001dd == 0) {
  ...
  async earnDailyPost(_0x21954b = {}) {
    ...
    try {
      ...
      await _0x34e7e4.wait_gap_interval(this.t_earnDaily, _0x5cae5c);
  ...
  async earnDaily_task_list(_0x401e09 = {}) {
    try {
      ...
      };
      {
        let {
            result: _0x1d442b
          } = await this.earnDailyPost(_0x81b07c),
          _0x49ce85 = _0x34e7e4.get(_0x1d442b, "code", -1);
        if (_0x49ce85 == 200) {
      ...
      }
      {
        let {
          ...
          _0x3f6b7f = _0x34e7e4.get(_0x7e5e64, "code", -1);
        if (_0x3f6b7f == 200) {
      ...
      }
      {
        let {
          ...
          _0x1864ed = _0x34e7e4.get(_0x5ac856, "code", -1);
        if (_0x1864ed == 200) {
  ...
  async earnDaily_coinInfo(_0xe26df9 = {}) {
    try {
      let _0x395b28 = {
        ...
        {
          result: _0x436ee4
        } = await this.earnDailyPost(_0x395b28),
        _0x2d87f0 = _0x34e7e4.get(_0x436ee4, "code", -1);
      if (_0x2d87f0 == 200) {
  ...
  async earnDaily_coinExchange(_0x428012, _0x368b8b = {}) {
    try {
      ...
      let _0x1ff578 = {
        ...
        {
          result: _0x527705
        } = await this.earnDailyPost(_0x1ff578),
        _0x19e5d4 = _0x34e7e4.get(_0x527705, "code", -1);
      if (_0x19e5d4 == 200) {
  ...
  async earnDaily_sign(_0x53f31b = {}) {
    try {
      let _0x402bf7 = {
        ...
        {
          result: _0x47dca9
        } = await this.earnDailyPost(_0x402bf7),
        _0x564510 = _0x34e7e4.get(_0x47dca9, "code", -1);
      if (_0x564510 == 200) {
  ...
  async earnDaily_do_task(_0x50c6db, _0x593bb4 = {}) {
    try {
      ...
      let _0xb9a4b9 = {
        ...
        {
          result: _0x3d5575
        } = await this.earnDailyPost(_0xb9a4b9),
        _0x18c47f = _0x34e7e4.get(_0x3d5575, "code", -1);
      if (_0x18c47f == 200) {
  ...
  async earnDaily_get_reward(_0x171fed, _0x24c45c = {}) {
    try {
      ...
      let _0xd06669 = {
        ...
        {
          result: _0x225b3a
        } = await this.earnDailyPost(_0xd06669),
        _0x5d376f = _0x34e7e4.get(_0x225b3a, "code", -1);
      if (_0x5d376f == 200) {
  ...
  async earnDaily_redbag(_0x3e1ef9 = {}) {
    try {
      let _0x38ec83 = {
        ...
        {
          result: _0x437b86
        } = await this.earnDailyPost(_0x38ec83),
        _0x37fe12 = _0x34e7e4.get(_0x437b86, "code", -1);
      if (_0x37fe12 == 200) {
  ...
  async earnDaily_draw(_0x531294 = {}) {
    try {
      let _0x385c2e = {
        ...
        {
          result: _0x353bbe
        } = await this.earnDailyPost(_0x385c2e),
        _0x375c8b = _0x34e7e4.get(_0x353bbe, "code", -1);
      if (_0x375c8b == 200) {
  ...
  async earnDaily_get_withdraw_list(_0x2f2491 = {}) {
    try {
      let _0x460e37 = {
        ...
        {
          result: _0x432b9a
        } = await this.earnDailyPost(_0x460e37),
        _0x1ed18c = _0x34e7e4.get(_0x432b9a, "code", -1);
      if (_0x1ed18c == 200) {
  ...
  async earnDaily_withdraw(_0x76f94a, _0x21cf4d = {}) {
    ...
    try {
      ...
      let _0x2ad41a = {
        ...
        {
          result: _0xa95d61
        } = await this.earnDailyPost(_0x2ad41a),
        _0x4c72f4 = _0x34e7e4.get(_0xa95d61, "code", -1);
      if (_0x4c72f4 == 200) {
        _0x1bd093 = true;
        const _0x4dea8f = {
          notify: true
    ...
    try {
      ...
      let _0x598c36 = {
        ...
        json: {
          ...
          t: "1",
          c: "2",
          sessionId: "187a" + _0x34e7e4.randomPattern("xxxxxxx-xxx-xxx-xxx"),
          referrer: "",
          fingerprintFromH5: "eJxVV" + _0x34e7e4.randomString(_0x48bc52, _0x2b49ff)
        }
      };
  ...
  async walletMainpage(_0x48bbe9 = {}) {
    try {
      ...
      let _0xd9570d = _0x33dddc,
        {
          result: _0xe4136f
        } = await this.request(_0xd9570d),
        _0x2e2445 = _0x34e7e4.get(_0xe4136f, "status", -1);
  ...
  async batchfetchcomponentcouponV2(_0x3bc861) {
    try {
      ...
      let {
        headers: _0x396721
      } = await this.get_mtgsig(_0x7ce831.toString(), _0x4a163a);
      const _0x30ee27 = {
  ...
  async popupcomponent_popup(_0x36bd60, _0x5d15b3 = {}) {
    try {
      ...
      let _0x3b7a14 = {
        ...
        {
          result: _0x4c3941
        } = await this.request(_0x3b7a14),
        _0x1e5766 = _0x34e7e4.get(_0x4c3941, "code", -1);
      if (_0x1e5766 == 0) {
  ...
  async xtb_login(_0x251e3 = {}) {
    ...
    try {
      let _0x25f0f9 = {
          ...
          json: {
            mtToken: this.token,
            deviceUUID: this.specified_app_uuid || _0xba91e5,
            mtUserId: this.userId,
            idempotentString: _0x34e7e4.randomString(16, _0x49f694 + _0x57a4fd)
          }
        },
        {
          result: _0x34549a
        } = await this.request(_0x34e7e4.copy(_0x25f0f9));
      ...
      let _0x57cd92 = _0x23cfee,
        {
          ...
          result: _0x436499
        } = await this.request(_0x34e7e4.copy(_0x57cd92)),
        _0x5eefff = _0x34e7e4.get(_0x436499, "code", _0x19f74c);
      if (_0x5eefff == 0) {
  ...
  async xtb_queryMgcTaskInfo(_0x58da9c = {}) {
    try {
      let _0x13bad3 = {
        ...
        _0x2de5b6 = "https://game.meituan.com/mgc/gamecenter/front/api/v1/mgcUser/task/queryMgcTaskInfo",
        _0x208c13 = new URL(_0x2de5b6);
      for (let _0x501911 in _0x13bad3) {
        _0x208c13.searchParams.append(_0x501911, _0x13bad3[_0x501911]);
      }
      ...
      let _0x75de33 = {
        ...
        },
        {
          ...
          result: _0x55268c
        } = await this.request(_0x34e7e4.copy(_0x75de33)),
        _0x31768e = _0x34e7e4.get(_0x55268c, "code", _0x5df26e);
      if (_0x31768e == 0) {
        ...
        for (let _0x3957d2 of _0x263568) {
          ...
          if (_0x474b5c) {
            ...
            await _0x34e7e4.wait(_0x4c40f8);
          }
        }
      } else {
    ...
    try {
      let _0x13d989 = JSON.parse(_0x10bcb5?.["mgcTaskBaseInfo"]?.["viewExtraJson"]),
        _0x62406f = {
          ...
          taskId: _0x663b13("mgc-gamecenter" + _0x10bcb5.id)
        },
      ...
      let _0x108b6e = {
        ...
        },
        {
          ...
          result: _0x4db091
        } = await this.request(_0x34e7e4.copy(_0x108b6e)),
        _0x4d310d = _0x34e7e4.get(_0x4db091, "code", _0x4c6703);
      if (_0x4d310d == 0) {
  ...
  async xtb_receiveMgcTaskReward(_0xec3f3b, _0x2ca23b = {}) {
    ...
    try {
      let _0x2b7e94 = {
        ...
        _0x481cd3 = "https://game.meituan.com/mgc/gamecenter/front/api/v1/mgcUser/task/receiveMgcTaskReward",
        _0x36baf8 = new URL(_0x481cd3);
      for (let _0x137ec2 in _0x2b7e94) {
        _0x36baf8.searchParams.append(_0x137ec2, _0x2b7e94[_0x137ec2]);
      }
      ...
      let _0x1c858b = {
        ...
        },
        {
          ...
          result: _0x3ef218
        } = await this.request(_0x34e7e4.copy(_0x1c858b)),
        _0x364dbd = _0x34e7e4.get(_0x3ef218, "code", _0x46a9bf);
      if (_0x364dbd == 0) {
        _0x3084af = true;
        let {
          succ: _0x183560,
  ...
  async xtb_finishAndReceiveReward(_0x4a3630, _0x334e13 = {}) {
    ...
    try {
      let _0x52cd29 = {
        ...
        _0x3d9a8f = "https://game.meituan.com/mgc/gamecenter/front/api/v1/mgcUser/task/finishAndReceiveReward",
        _0x52e767 = new URL(_0x3d9a8f);
      for (let _0x5c2cc6 in _0x52cd29) {
        _0x52e767.searchParams.append(_0x5c2cc6, _0x52cd29[_0x5c2cc6]);
      }
      _0x52e767 = _0x52e767.toString();
      let _0xe4a94c = {
          taskId: _0x663b13("mgc-gamecenter" + _0x4a3630.id),
          externalStr: "",
          riskParams: await this.get_riskParams()
        },
        {
      ...
      let _0x1cedfb = {
        ...
        },
        {
          ...
          result: _0x361d85
        } = await this.request(_0x34e7e4.copy(_0x1cedfb)),
        _0x3b0d53 = _0x34e7e4.get(_0x361d85, "code", _0xdcc96e);
      if (_0x3b0d53 == 0) {
        _0x505090 = true;
        let {
          succ: _0x11fb45,
  ...
  async signlottery_info(_0x58632c, _0x1ffd73 = {}) {
    try {
      ...
      let _0x39c683 = {
        ...
        {
          result: _0xdedbc3
        } = await this.request(_0x39c683),
        _0x5a2f1d = _0x34e7e4.get(_0xdedbc3, "code", -1),
        _0x193497 = _0x34e7e4.get(_0xdedbc3, "subcode", -1);
  ...
  async signlottery_signIn(_0x557ee7, _0x47e87f = {}) {
    try {
      ...
      let _0x4c832e = {
        ...
        {
          result: _0xac276b
        } = await this.request(_0x4c832e),
        _0x52defb = _0x34e7e4.get(_0xac276b, "code", -1),
        _0x5c36d4 = _0x34e7e4.get(_0xac276b, "subcode", -1);
  ...
  async generalcoupon_info(_0x173f54, _0x6a94d0 = {}) {
    try {
      ...
      let _0x4cea84 = {
        ...
        {
          result: _0xd0b867
        } = await this.request(_0x4cea84),
        _0x539bc4 = _0x34e7e4.get(_0xd0b867, "code", -1),
        _0x158d73 = _0x34e7e4.get(_0xd0b867, "subcode", -1);
      if (_0x539bc4 == 0 && _0x158d73 == 0) {
        ...
        for (let _0x111586 of _0xd0b867?.["data"]?.["config"]?.["tabs"] || []) {
          ...
          for (let _0x2fee89 of (_0xd0b867?.["data"]?.["couponList"] || []).filter(_0x47465d => _0x47465d.planCode == _0x111586.rightsToken)) {
            _0x2fee89.status == 0 ? _0x50ed98.rightCodes.push(_0x2fee89.rightCode) : _0x58fca0 = true;
          }
          _0x50ed98.rightCodes.length && _0x509d76.push(_0x50ed98);
        }
        if (_0x509d76.length) {
  ...
  async generalcoupon_fetch(_0x4420cc, _0x4fb02a, _0x364e0c = {}) {
    try {
      ...
      let _0x5ab789 = _0x24ba8a,
        {
          result: _0x1600dc
        } = await this.request(_0x5ab789),
        _0x4bb21b = _0x34e7e4.get(_0x1600dc, "code", -1),
        _0x521413 = _0x34e7e4.get(_0x1600dc, "subcode", -1);
    ...
    for (let _0x5b46df of _0x57186e) {
      ...
      if (_0x5b46df.taskIdKeys.length > _0x599182) {
        ...
        for (let _0x3bf04e of _0x5b46df.taskIdKeys) {
          _0x26e62e.taskIdKeys.push(_0x3bf04e);
          _0x26e62e.taskIdKeys.length >= _0x599182 && (await this.getUserTasks(_0x26e62e), _0x26e62e.taskIdKeys = []);
        }
        if (_0x26e62e.taskIdKeys.length > 0) {
          await this.getUserTasks(_0x26e62e);
        }
      } else {
...
!(async () => {
  ...
  await _0x40de8e();
  _0x34e7e4.read_env(_0x264822);
  _0x34e7e4.log("\n-------------------------------------");
  let _0x3da026 = _0x128bdf == "false" ? "关闭" : "开启";
  _0x34e7e4.log("APP每日赚钱任务开关设置为: " + _0x3da026);
  let _0x2867ac = _0x16913c == "false" ? "不随机提现" : "每日随机提现";
  _0x34e7e4.log("APP每日赚钱设置为: " + _0x2867ac);
  let _0x26c84b = _0x539959 == "false" ? "关闭" : "开启";
  _0x34e7e4.log("抽月符任务开关设置为: " + _0x26c84b);
  _0x34e7e4.log("-------------------------------------");
  for (let _0x2f4f31 of _0x34e7e4.userList) {
    await _0x2f4f31.userTask();
  }
  let _0x32a111 = _0x34e7e4.userList.filter(_0x428966 => _0x428966.valid);
  if (_0x32a111.length) {
    const _0x4992d7 = {
      notify: true
    };
...
})().catch(_0x229918 => _0x34e7e4.log(_0x229918)).finally(() => _0x34e7e4.exitNow());
  ...
  try {
    let _0x324bff = {
      ...
      },
      {
        ...
        result: _0x2e87b9
      } = await _0x1f9788.request(_0x324bff);
    if (_0x246e85 != 200) {
      return Promise.resolve();
    }
    if (_0x2e87b9?.["code"] == 0) {
      ...
      if (_0x2e87b9?.["commonNotify"] && _0x2e87b9.commonNotify.length > 0) {
        ...
        _0x34e7e4.log(_0x2e87b9.commonNotify.join("\n") + "\n", _0xd8e94e);
      }
      _0x2e87b9?.["commonMsg"] && _0x2e87b9.commonMsg.length > 0 && _0x34e7e4.log(_0x2e87b9.commonMsg.join("\n") + "\n");
      if (_0x2e87b9[_0x5f08d3]) {
        let _0x12d8ae = _0x2e87b9[_0x5f08d3];
        _0x12d8ae.status == 0 ? _0x442aac >= _0x12d8ae.version ? (_0x33f2db = true, _0x34e7e4.log(_0x12d8ae.msg[_0x12d8ae.status]), _0x34e7e4.log(_0x12d8ae.updateMsg), _0x34e7e4.log("现在运行的脚本版本是：" + _0x442aac.toFixed(2) + "，最新脚本版本：" + _0x12d8ae.latestVersion.toFixed(2))) : _0x34e7e4.log(_0x12d8ae.versionMsg) : _0x34e7e4.log(_0x12d8ae.msg[_0x12d8ae.status]);
      } else {
        _0x34e7e4.log(_0x2e87b9.errorMsg);
      }
    }
  } catch (_0x381542) {
    _0x34e7e4.log(_0x381542);
  } finally {
    return _0x33f2db;
  }
}
  ...
  try {
    let _0x2c60bb = {
      ...
      },
      {
        ...
        result: _0x31bc2a
      } = await _0x1f9788.request(_0x2c60bb);
    if (_0x5119c5 != 200) {
      return Promise.resolve();
    }
    if (_0x31bc2a?.["code"] == 0) {
      _0x31bc2a = JSON.parse(_0x31bc2a.data.file.data);
      _0x50dbed = _0x31bc2a?.["inviteCode"] || _0x50dbed;
...
function _0x9f9777(_0x20f6fe) {
  return new class {
    ...
    log(_0xbc5837, _0x30d1aa = {}) {
      let _0x355dad = {
        console: true
      };
      Object.assign(_0x355dad, _0x30d1aa);
      if (_0x355dad.time) {
        let _0x1f2787 = _0x355dad.fmt || "hh:mm:ss";
        _0xbc5837 = "[" + this.time(_0x1f2787) + "]" + _0xbc5837;
      }
      if (_0x355dad.notify) {
        this.notifyStr.push(_0xbc5837);
      }
      if (_0x355dad.console) {
        console.log(_0xbc5837);
      }
    }
    read_env(_0x4109c1) {
      let _0x303e95 = _0x1d722f.map(_0x42adc0 => process.env[_0x42adc0]);
      for (let _0x46e024 of _0x303e95.filter(_0x35fa1a => !!_0x35fa1a)) {
        let _0x15b7d0 = _0x29b2e0.filter(_0x16017f => _0x46e024.includes(_0x16017f)),
          _0xcdb267 = _0x15b7d0.length > 0 ? _0x15b7d0[0] : _0x29b2e0[0];
        for (let _0x5106ff of _0x46e024.split(_0xcdb267).filter(_0x2a1ab0 => !!_0x2a1ab0)) {
          this.userList.push(new _0x4109c1(_0x5106ff));
        }
      }
      ...
      if (!this.userCount) {
        ...
        this.log("未找到变量，请检查变量" + _0x1d722f.map(_0x4693fa => "[" + _0x4693fa + "]").join("或"), _0x48a05f);
        return false;
      }
      this.log("共找到" + this.userCount + "个账号");
      return true;
    }
    async threads(_0x4ad66e, _0x592f05, _0x1ffc26 = {}) {
      while (_0x592f05.idx < _0x34e7e4.userList.length) {
        let _0x3ff786 = _0x34e7e4.userList[_0x592f05.idx++];
        if (!_0x3ff786.valid) {
          continue;
        }
    ...
    async threadTask(_0x1efa9a, _0x4269b7) {
      let _0xb9d0af = [];
      let _0x17d093 = {
        idx: 0
      };
      while (_0x4269b7--) {
        _0xb9d0af.push(this.threads(_0x1efa9a, _0x17d093));
      }
      await Promise.all(_0xb9d0af);
    }
    time(_0x3379c7, _0x3b1b8f = null) {
      let _0x25c0f2 = _0x3b1b8f ? new Date(_0x3b1b8f) : new Date(),
        _0x307cd4 = {
          "M+": _0x25c0f2.getMonth() + 1,
          "d+": _0x25c0f2.getDate(),
          "h+": _0x25c0f2.getHours(),
          "m+": _0x25c0f2.getMinutes(),
          "s+": _0x25c0f2.getSeconds(),
          "q+": Math.floor((_0x25c0f2.getMonth() + 3) / 3),
          S: this.padStr(_0x25c0f2.getMilliseconds(), 3)
        };
      /(y+)/.test(_0x3379c7) && (_0x3379c7 = _0x3379c7.replace(RegExp.$1, (_0x25c0f2.getFullYear() + "").substr(4 - RegExp.$1.length)));
      for (let _0x5ab0b6 in _0x307cd4) new RegExp("(" + _0x5ab0b6 + ")").test(_0x3379c7) && (_0x3379c7 = _0x3379c7.replace(RegExp.$1, 1 == RegExp.$1.length ? _0x307cd4[_0x5ab0b6] : ("00" + _0x307cd4[_0x5ab0b6]).substr(("" + _0x307cd4[_0x5ab0b6]).length)));
      return _0x3379c7;
    }
    async showmsg() {
      if (!this.notifyFlag) {
      ...
      var _0x498ccd = require("./sendNotify");
      this.log("\n============== 推送 ==============");
      await _0x498ccd.sendNotify(this.name, this.notifyStr.join("\n"));
    }
    padStr(_0x171f76, _0x4649ad, _0x17fee9 = {}) {
      let _0x5e2f7d = _0x17fee9.padding || "0",
        _0x771204 = _0x17fee9.mode || "l",
        _0x25dacc = String(_0x171f76),
        _0x4d9909 = _0x4649ad > _0x25dacc.length ? _0x4649ad - _0x25dacc.length : 0,
        _0x130a7b = "";
      for (let _0x382190 = 0; _0x382190 < _0x4d9909; _0x382190++) {
        _0x130a7b += _0x5e2f7d;
      }
      _0x771204 == "r" ? _0x25dacc = _0x25dacc + _0x130a7b : _0x25dacc = _0x130a7b + _0x25dacc;
      return _0x25dacc;
    }
    json2str(_0x44f5ca, _0x2b5565, _0x508507 = false) {
      let _0x5c0a35 = [];
      for (let _0x45b6b0 of Object.keys(_0x44f5ca).sort()) {
        let _0x167aff = _0x44f5ca[_0x45b6b0];
        if (_0x167aff && _0x508507) {
          _0x167aff = encodeURIComponent(_0x167aff);
        }
        _0x5c0a35.push(_0x45b6b0 + "=" + _0x167aff);
      }
      return _0x5c0a35.join(_0x2b5565);
    }
    str2json(_0x586e43, _0x5cb48d = false) {
      let _0x45d8b0 = {};
      for (let _0x206f31 of _0x586e43.split("&")) {
        if (!_0x206f31) {
          continue;
        }
        let _0x5a8d68 = _0x206f31.indexOf("=");
        if (_0x5a8d68 == -1) {
          continue;
        }
        let _0x182bcf = _0x206f31.substr(0, _0x5a8d68),
          _0x541849 = _0x206f31.substr(_0x5a8d68 + 1);
        if (_0x5cb48d) {
          _0x541849 = decodeURIComponent(_0x541849);
        }
        _0x45d8b0[_0x182bcf] = _0x541849;
      }
      return _0x45d8b0;
    }
    randomPattern(_0x5e2b32, _0xb9b6f5 = "abcdef0123456789") {
      let _0x12a6b1 = "";
      for (let _0x4f4532 of _0x5e2b32) {
        if (_0x4f4532 == "x") {
          _0x12a6b1 += _0xb9b6f5.charAt(Math.floor(Math.random() * _0xb9b6f5.length));
        } else {
          _0x4f4532 == "X" ? _0x12a6b1 += _0xb9b6f5.charAt(Math.floor(Math.random() * _0xb9b6f5.length)).toUpperCase() : _0x12a6b1 += _0x4f4532;
        }
      }
      return _0x12a6b1;
    }
    randomString(_0xf72c1b, _0x4f212d = "abcdef0123456789") {
      let _0x448b19 = "";
      for (let _0x5df0b8 = 0; _0x5df0b8 < _0xf72c1b; _0x5df0b8++) {
        _0x448b19 += _0x4f212d.charAt(Math.floor(Math.random() * _0x4f212d.length));
      }
      return _0x448b19;
    }
    randomList(_0x3e7138) {
      let _0x45c3fa = Math.floor(Math.random() * _0x3e7138.length);
    ...
    async exitNow() {
      ...
      let _0x530b63 = Date.now(),
        _0x467ef0 = (_0x530b63 - this.startTime) / 1000;
      this.log("");
      const _0x35e116 = {
        time: true
      };
      this.log("[" + this.name + "]运行结束，共运行了" + _0x467ef0 + "秒", _0x35e116);
      process.exit(0);
    }
    get(_0x353ae5, _0x142ab3, _0x21578f = "") {
      let _0x2dba86 = _0x21578f;
      _0x353ae5?.["hasOwnProperty"](_0x142ab3) && (_0x2dba86 = _0x353ae5[_0x142ab3]);
      return _0x2dba86;
    }
    pop(_0x50bb8c, _0x571f6d, _0x1c80fd = "") {
      let _0x2dd8ed = _0x1c80fd;
      _0x50bb8c?.["hasOwnProperty"](_0x571f6d) && (_0x2dd8ed = _0x50bb8c[_0x571f6d], delete _0x50bb8c[_0x571f6d]);
      return _0x2dd8ed;
    }
    copy(_0x39a32b) {
      return Object.assign({}, _0x39a32b);
    }
    async wait_gap_interval(_0x3c1549, _0x22d417) {
      let _0x47ff90 = Date.now() - _0x3c1549;
